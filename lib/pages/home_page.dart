...
import 'package:weather_app_123/utils/constants.dart';
import 'package:weather_app_123/utils/weather_preferences.dart';
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('images/weather123.png'),
            fit: BoxFit.cover,
          )
        ),
        ...
        //     colors: [
        //        Color.fromARGB(255, 153, 33, 53).withOpacity(.8),
        //       Color.fromARGB(255, 38, 91, 14),
        //     ]
        //   )
        // ),
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Image.network('$iconPrefix${current.weather![0].icon}$iconSuffix',color: Colors.white,),
          Text(
            ...
            child: Wrap(
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.water_drop_outlined,size:30,color: Colors.white60,),
                      SizedBox(width: 10,),
                      Text(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.compress_outlined,size:30,color: Colors.white60,),
                      SizedBox(width: 10,),
                      Text(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.waves_outlined,size:30,color: Colors.white60,),
                      SizedBox(width: 10,),
                      Text(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.rotate_90_degrees_ccw_outlined,size:30,color: Colors.white60,),
                      SizedBox(width: 10,),
                      Text(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.remove_red_eye_outlined,size:30,color: Colors.white60,),
                      SizedBox(width: 10,),
                      Text(
          ...
          Padding(
            ...
            child: Wrap(
              children: [
                Row(
                  children: [
                    Icon(Icons.wb_twilight_outlined,size:18,color: Colors.yellow,),
                    Text(
                ...
                Row(
                  children: [
                    Icon(Icons.sunny_snowing,size:20,color: Colors.red,),
                    Text(
